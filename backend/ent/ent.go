...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			competitionresult.Table:       competitionresult.ValidColumn,
			fcmtoken.Table:                fcmtoken.ValidColumn,
			goal.Table:                    goal.ValidColumn,
			invite.Table:                  invite.ValidColumn,
			notification.Table:            notification.ValidColumn,
			notificationpreferences.Table: notificationpreferences.ValidColumn,
			post.Table:                    post.ValidColumn,
			profile.Table:                 profile.ValidColumn,
			squad.Table:                   squad.ValidColumn,
			user.Table:                    user.ValidColumn,
			workout.Table:                 workout.ValidColumn,
			workoutdata.Table:             workoutdata.ValidColumn,
			workoutroutedata.Table:        workoutroutedata.ValidColumn,
		})
	})
