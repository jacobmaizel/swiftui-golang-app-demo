...
// AutoSyncWorkouts applies equality check predicate on the "auto_sync_workouts" field. It's identical to AutoSyncWorkoutsEQ.
func AutoSyncWorkouts(v bool) predicate.AppConfig {
	return predicate.AppConfig(sql.FieldEQ(FieldAutoSyncWorkouts, v))
}
...
// AutoSyncWorkoutsEQ applies the EQ predicate on the "auto_sync_workouts" field.
func AutoSyncWorkoutsEQ(v bool) predicate.AppConfig {
	return predicate.AppConfig(sql.FieldEQ(FieldAutoSyncWorkouts, v))
}

// AutoSyncWorkoutsNEQ applies the NEQ predicate on the "auto_sync_workouts" field.
func AutoSyncWorkoutsNEQ(v bool) predicate.AppConfig {
	return predicate.AppConfig(sql.FieldNEQ(FieldAutoSyncWorkouts, v))
}

// HasProfile applies the HasEdge predicate on the "profile" edge.
func HasProfile() predicate.AppConfig {
...
func HasProfileWith(preds ...predicate.Profile) predicate.AppConfig {
	return predicate.AppConfig(func(s *sql.Selector) {
		step := newProfileStep()
